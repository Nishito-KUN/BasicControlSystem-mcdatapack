...
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:13b,id:"minecraft:iron_axe",tag:{HideFlags:2,display:{Name:"{\"text\":\"battle royaleの装備\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.4 minecraft:iron_axe{HideFlags:2,display:{Name:"{\"text\":\"battle royaleの装備\"}",Lore:["閉じる (shift + click)"]}}
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:22b,id:"minecraft:barrier",tag:{display:{Name:"{\"text\":\"このゲームには装備アイテムがありません\"}"}}}]}] run replaceitem entity @s inventory.13 minecraft:barrier{display:{Name:"{\"text\":\"このゲームには装備アイテムがありません\"}"}}

execute if entity @s[nbt={Inventory:[{Count:1b,Slot:0b,id:"minecraft:iron_axe",tag:{HideFlags:2,display:{Name:"{\"text\":\"battle royaleの装備\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.26 minecraft:paper{display:{Name:"{\"text\":\"page.items\"}"}}