...
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:13b,id:"minecraft:anvil",tag:{display:{Name:"{\"text\":\"他のゲームの装備\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.4 minecraft:anvil{display:{Name:"{\"text\":\"他のゲームの装備\"}",Lore:["閉じる (shift + click)"]}}
...
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:0b,id:"minecraft:anvil",tag:{display:{Name:"{\"text\":\"他のゲームの装備\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.26 minecraft:paper{display:{Name:"{\"text\":\"page.items\"}"}}
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:0b,id:"minecraft:iron_axe",tag:{HideFlags:2,display:{Name:"{\"text\":\"battle royale\"}",Lore:["(shift + click)"]}}}]}] run replaceitem entity @s inventory.26 minecraft:paper{display:{Name:"{\"text\":\"page.battle_royale_items\"}"}}