...
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:13b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.4 minecraft:paper{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["閉じる (shift + click)"]}}
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:9b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["(shift + click)"]}}}]}] run replaceitem entity @s inventory.0 minecraft:air{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["(shift + click)"]}}

execute if entity @s[nbt={Inventory:[{Count:1b,Slot:0b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.26 minecraft:paper{display:{Name:"{\"text\":\"page.top\"}"}}
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:0b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["(shift + click)"]}}}]}] run replaceitem entity @s inventory.26 minecraft:paper{display:{Name:"{\"text\":\"page.EXAMPLE\"}"}}