...
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:13b,id:"minecraft:firework_rocket",tag:{display:{Name:"{\"text\":\"ショップ\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.4 minecraft:firework_rocket{display:{Name:"{\"text\":\"ショップ\"}",Lore:["閉じる (shift + click)"]}}
...
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:0b,id:"minecraft:firework_rocket",tag:{display:{Name:"{\"text\":\"ショップ\"}",Lore:["閉じる (shift + click)"]}}}]}] run replaceitem entity @s inventory.26 minecraft:paper{display:{Name:"{\"text\":\"page.top\"}"}}