...
execute if score game dummy matches 1..17 run function system:message/message_title_actionbar
...
#game:1
execute if score game dummy matches 1 if score players dummy >= start dummy run tellraw @a ["",{"text":"[system]","color":"aqua"},{"text":" まもなく試合を開始します"}]
...
execute if score game dummy matches 2 if score timer_t dummy matches 0 if score timer_s dummy matches 0 run tellraw @a ["",{"text":"[system]","color":"aqua"},{"text":" 試合が開始されました"}]
...
execute if score game dummy matches 4 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 3 run function system:message/message_worldborder_center
execute if score game dummy matches 4 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 2 run function system:message/message_worldborder_set_countdown
execute if score game dummy matches 4 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 1 run function system:message/message_worldborder_set_countdown
execute if score game dummy matches 4 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_set_countdown
...
execute if score game dummy matches 5 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 2 run function system:message/message_worldborder_set
...
execute if score game dummy matches 6 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 2 run function system:message/message_worldborder_center
execute if score game dummy matches 6 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 1 run function system:message/message_worldborder_set_countdown
execute if score game dummy matches 6 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_set_countdown
...
execute if score game dummy matches 7 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 1 run function system:message/message_worldborder_set
...
execute if score game dummy matches 8 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 1 run function system:message/message_worldborder_center
execute if score game dummy matches 8 if score timer_t dummy matches 0 if score timer_s dummy matches 20 if score timer_m dummy matches 0 run function system:message/message_worldborder_set_countdown
...
execute if score game dummy matches 9 if score timer_t dummy matches 0 if score timer_s dummy matches 0 if score timer_m dummy matches 1 run function system:message/message_worldborder_set
...
execute if score game dummy matches 10 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_center
execute if score game dummy matches 10 if score timer_t dummy matches 0 if score timer_s dummy matches 10 if score timer_m dummy matches 0 run function system:message/message_worldborder_set_countdown
...
execute if score game dummy matches 11 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_set
...
execute if score game dummy matches 12 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_center
execute if score game dummy matches 12 if score timer_t dummy matches 0 if score timer_s dummy matches 10 if score timer_m dummy matches 0 run function system:message/message_worldborder_set_countdown
...
execute if score game dummy matches 13 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_set
...
execute if score game dummy matches 14 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_center
execute if score game dummy matches 14 if score timer_t dummy matches 0 if score timer_s dummy matches 10 if score timer_m dummy matches 0 run function system:message/message_worldborder_set_countdown
...
execute if score game dummy matches 15 if score timer_t dummy matches 0 if score timer_s dummy matches 30 if score timer_m dummy matches 0 run function system:message/message_worldborder_set
...
#game:17
execute if score game dummy matches 17 if score timer_t dummy matches 0 if score timer_s dummy matches 30 run tellraw @a ["",{"text":"[system]","color":"aqua"},{"text":" "},{"selector":"@a[scores={join=4}]"},{"text":"が勝利しました。試合を終了します"}]
