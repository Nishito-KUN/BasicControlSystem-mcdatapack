...
#join:3
execute if score phase dummy matches 3.. run scoreboard players set @a[scores={join=3},gamemode=survival] join 1
execute if score phase dummy matches 3.. run tellraw @a[scores={join=3}] ["",{"text":"[system]","color":"aqua"},{"text":" "},{"text":"ゲームに参加","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 5"}},{"text":" "},{"text":"ゲームを観戦","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 3"}},{"text":" "},{"text":"ロビーに戻る\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 1"}}]
execute if score phase dummy matches 3.. run scoreboard players set @a[scores={join=3}] join 2
scoreboard players set @a[scores={join=3}] join 1

#join:5
execute if score phase dummy matches 3.. run scoreboard players set @a[scores={join=5},team=] join 1
execute if score phase dummy matches 2.. run tellraw @a[scores={join=5}] ["",{"text":"[system]","color":"aqua"},{"text":" "},{"text":"ゲームに参加","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 5"}},{"text":" "},{"text":"ゲームを観戦","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 3"}},{"text":" "},{"text":"ロビーに戻る\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 1"}}]
execute if score phase dummy matches 2.. run scoreboard players set @a[scores={join=5}] join 4
