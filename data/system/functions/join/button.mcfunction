...
execute if score match dummy matches 2.. run tellraw @a[scores={button=1}] ["",{"text":"[system]","color":"aqua"},{"text":" ロビーに戻りますか? "},{"text":"ロビーに戻る\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 2"}}]
execute if score match dummy matches 2.. run scoreboard players set @a[scores={button=1}] button 0
...
execute if score match dummy matches 2.. run tellraw @a[scores={button=3,join=4}] ["",{"text":"[system]","color":"aqua"},{"text":" 試合を観戦しますか? "},{"text":"観戦する\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 4"}}]
execute if score match dummy matches 2.. run scoreboard players set @a[scores={button=3,join=4}] button 0

execute if score match dummy matches 3.. run kill @a[scores={button=4,join=4}]
...
execute if score match dummy matches 3.. run gamemode spectator @a[scores={button=3..4}]
execute if score match dummy matches 3.. run clear @a[scores={button=3..4}]
execute if score match dummy matches 3.. run effect clear @a[scores={button=3..4}]
execute if score match dummy matches 3.. run tp @a[scores={button=3..4}] @r[scores={join=4}]
execute if score match dummy matches 3.. run tellraw @a[scores={button=3..4}] ["",{"text":"[system]","color":"aqua"},{"text":" 観戦者になりました"}]
execute if score match dummy matches 3.. run scoreboard players set @a[scores={button=3..4}] join 2
execute if score match dummy matches 3.. run scoreboard players set @a[scores={button=3..4}] button 0
...
#参加
execute if score match dummy matches 3.. run tellraw @a[scores={button=5,join=0}] ["",{"text":"[system]","color":"aqua"},{"text":" 試合中は参加できません"}]
execute if score match dummy matches 3.. run scoreboard players set @a[scores={button=5,join=0}] button 0

execute if score match dummy matches 3.. run tellraw @a[scores={button=5,join=2}] ["",{"text":"[system]","color":"aqua"},{"text":" 試合中は参加できません"}]
execute if score match dummy matches 3.. run scoreboard players set @a[scores={button=5,join=2}] button 0
