...
#join:3
execute if score match dummy matches 3.. run tellraw @a[scores={join=3}] ["",{"text":"[system]","color":"aqua"},{"text":" "},{"text":"試合に参加","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 5"}},{"text":" "},{"text":"試合を観戦","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 3"}},{"text":" "},{"text":"ロビーに戻る\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 1"}}]
