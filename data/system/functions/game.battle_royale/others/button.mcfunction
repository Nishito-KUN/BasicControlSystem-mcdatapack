...
execute if score phase control matches 1..17 run tellraw @a[scores={button=1}] ["",{"text":"[system]","color":"aqua"},{"text":" ロビーに戻りますか? "},{"text":"ロビーに戻る\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 2"}}]
execute if score phase control matches 1..17 run scoreboard players set @a[scores={button=1}] button 0

execute if score phase control matches 2..17 run team leave @a[scores={button=1..2,join=4}]
...
execute if score phase control matches 1..15 run tellraw @a[scores={button=3,join=4}] ["",{"text":"[system]","color":"aqua"},{"text":" ゲームを観戦しますか? "},{"text":"観戦する\n","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger button set 4"}}]
execute if score phase control matches 1..15 run scoreboard players set @a[scores={button=3,join=4}] button 0
execute if score phase control matches 16..17 run tellraw @a[scores={button=3..4}] ["",{"text":"[system]","color":"aqua"},{"text":" 現在ゲーム終了中です。しばらくお待ちください"}]
execute if score phase control matches 16..17 run scoreboard players set @a[scores={button=3..4}] button 0
execute if score phase control matches 2..15 run kill @a[scores={button=4,join=4}]
...
execute as @a[scores={death=1}] run tellraw @s ["",{"text":"[system]","color":"aqua"},{"text":" "},{"score":{"name":"players","objective":"control"}},{"text":"位 "},{"selector":"@s","color":"white"},{"text":" "},{"score":{"name":"@s","objective":"kill"}},{"text":"キル"}]
scoreboard players set @a[scores={death=1}] death 0

#spectate
execute if score phase control matches 2..15 run gamemode spectator @a[scores={button=3..4}]
execute if score phase control matches 2..15 run clear @a[scores={button=3..4}]
execute if score phase control matches 2..15 run effect clear @a[scores={button=3..4}]
execute if score phase control matches 2..15 run tp @a[scores={button=3}] @r[scores={join=4}]
execute if score phase control matches 2..15 run tellraw @a[scores={button=3..4}] ["",{"text":"[system]","color":"aqua"},{"text":" 観戦者になりました"}]
execute if score phase control matches 2..15 run scoreboard players set @a[scores={button=3..4}] join 2
execute if score phase control matches 2..15 run scoreboard players set @a[scores={button=3..4}] button 0
...
execute if score phase control matches 2..15 run tellraw @a[scores={button=5}] ["",{"text":"[system]","color":"aqua"},{"text":" ゲーム中は参加できません"}]
execute if score phase control matches 2..15 run scoreboard players set @a[scores={button=5}] button 0
execute if score phase control matches 16..17 run tellraw @a[scores={button=5}] ["",{"text":"[system]","color":"aqua"},{"text":" 現在ゲーム終了中です。しばらくお待ちください"}]
execute if score phase control matches 16..17 run scoreboard players set @a[scores={button=5}] button 0

execute if score game control matches 1 run gamemode adventure @a[scores={button=5}]
execute if score game control matches 2 run gamemode survival @a[scores={button=5}]
