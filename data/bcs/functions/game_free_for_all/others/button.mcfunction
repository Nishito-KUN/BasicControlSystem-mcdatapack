...
execute if score phase control matches 2 run tp @a[scores={button=3..4}] @r[scores={join=4}]
...
execute if score phase control matches 2 if score game control matches 3 run gamemode adventure @a[scores={button=5}]
execute if score phase control matches 2 if score game control matches 4 run gamemode survival @a[scores={button=5}]
execute if score phase control matches 2 if score game control matches 5 run gamemode adventure @a[scores={button=5}]
execute if score phase control matches 2 if score game control matches 6 run gamemode survival @a[scores={button=5}]
execute if score phase control matches 2 run scoreboard players set @a[scores={button=5}] kill 0
execute if score phase control matches 2 run team join game @a[scores={button=5}]
execute if score phase control matches 2 run effect clear @a[scores={button=5}]
execute if score phase control matches 2 as @a[scores={button=5}] run function system:game_death_match/players/players_set_items
execute if score phase control matches 2 at @e[type=minecraft:armor_stand,name=center] run spreadplayers ~ ~ 0 50 false @a[scores={button=5}]
...
execute if score game control matches 3 run gamemode adventure @a[scores={button=5}]
execute if score game control matches 4 run gamemode survival @a[scores={button=5}]
execute if score game control matches 5 run gamemode adventure @a[scores={button=5}]
execute if score game control matches 6 run gamemode survival @a[scores={button=5}]
