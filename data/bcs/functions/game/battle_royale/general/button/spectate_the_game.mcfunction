...
execute if score phase bcs.control matches 1..19 as @s[scores={bcs.join=4}] run function bcs:library/message/tellraw/button/confirm_spectate
execute if score phase bcs.control matches 1..19 as @s[scores={bcs.join=4}] run scoreboard players set @s bcs.button 0
...
execute if score phase bcs.control matches 2..19 as @s[scores={bcs.button=3..4,bcs.join=4}] run function bcs:game/battle_royale/player/button/spectate_the_in_game
