...
execute if score phase bcs.control matches 2..19 as @s[scores={bcs.button=4,bcs.join=4},team=bcs.game] run kill @s
execute if score phase bcs.control matches 2..19 as @s[scores={bcs.button=4,bcs.join=4},team=bcs.game] run function bcs:game/battle_royale/general/death
