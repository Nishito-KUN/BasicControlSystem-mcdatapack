...
function bcs:game/battle_royale/player/descent/control
...
execute if score phase bcs.control matches 19 run function bcs:game/battle_royale/phase/empty_phase
