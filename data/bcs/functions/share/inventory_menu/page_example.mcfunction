...
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:9b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["(shift + click)"]}}}]}] run replaceitem entity @s inventory.0 minecraft:paper{display:{Name:"{\"text\":\"EXAMPLE\"}",Lore:["(shift + click)"]}}
