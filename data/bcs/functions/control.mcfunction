execute unless score game bcs.control matches 0 as @a[tag=!bcs.registered] run function bcs:register
execute unless score game bcs.control matches 0 run function bcs:library/world/lobby_guard
...
execute if score game bcs.control matches 1 run function bcs:main/control
execute if score game bcs.control matches 2 run function bcs:game/battle_royale/control
execute if score game bcs.control matches 3 run function bcs:game/free_for_all/control
